...
#ifndef GHG_QJSONARRAY_H
#define GHG_QJSONARRAY_H
...
class GHGJSON_EXPORT QJsonArray
{
public:
    QJsonArray();
...
private:
    ...
    friend GHGJSON_EXPORT QDebug operator<<(QDebug, const QJsonArray &);
...
GHGJSON_EXPORT QDebug operator<<(QDebug, const QJsonArray &);
#endif

}

#endif // GHG_QJSONARRAY_H
