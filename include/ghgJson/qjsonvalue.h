...
#ifndef GHG_QJSONVALUE_H
#define GHG_QJSONVALUE_H
...
class GHGJSON_EXPORT QJsonValue
{
public:
    enum Type {
        Null =  0x0,
    ...
    QJsonValue(bool b);
    QJsonValue(double n);
    QJsonValue(const QDecimal& decimal);
    QJsonValue(int n);
    QJsonValue(qint64 n);
    ...
    QDecimal toDecimal(const QString &defaultValue = "0") const;
...
private:
    ...
    friend GHGJSON_EXPORT QDebug operator<<(QDebug, const QJsonValue &);
...
class GHGJSON_EXPORT QJsonValueRef
{
public:
    ...
    inline QDecimal toDecimal(const QString &defaultValue = "0") const { return toValue().toDecimal(defaultValue); }
...
GHGJSON_EXPORT QDebug operator<<(QDebug, const QJsonValue &);
#endif

}

#endif // GHG_QJSONVALUE_H
