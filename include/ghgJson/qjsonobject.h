...
#ifndef GHG_QJSONOBJECT_H
#define GHG_QJSONOBJECT_H
...
class GHGJSON_EXPORT QJsonObject
{
public:
    QJsonObject();
...
private:
    ...
    friend GHGJSON_EXPORT QDebug operator<<(QDebug, const QJsonObject &);
...
GHGJSON_EXPORT QDebug operator<<(QDebug, const QJsonObject &);
#endif

}

#endif // GHG_QJSONOBJECT_H
