...
#ifndef GHG_QJSON_P_H
#define GHG_QJSON_P_H
...
*/
#define Q_DECLARE_JSONPRIVATE_TYPEINFO(Class, Flags) } } Q_DECLARE_TYPEINFO(ghg::QJsonPrivate::Class, Flags); namespace ghg { namespace QJsonPrivate {
...
template <typename T>
class QTypeInfo<ghg::QJsonPrivate::q_littleendian<T> >
    : public QTypeInfoMerger<ghg::QJsonPrivate::q_littleendian<T>, T> {};
...
{
    Q_ASSERT(type == QJsonValue::String);
    if (latinOrIntValue)
